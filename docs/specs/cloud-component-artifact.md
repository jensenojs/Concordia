...
Cargo.lock SHA256固定为`25af8d8ea6826c1e7a0a98dbe28823cdfa6a3bb1fd83cea0fea9b7aaa94d475b`，与本地成功build和旧控制仓冻结副本逐字节一致。`ext/llvm-project`与`ext/cuda-tile`不参与该profile。
